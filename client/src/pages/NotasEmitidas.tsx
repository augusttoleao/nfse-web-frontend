    ...
    return (
      <div className="p-6">
        <Alert>
          ...
          <AlertDescription>Selecione uma empresa no canto superior direito para consultar notas emitidas.</AlertDescription>
        </Alert>
      </div>
    );
  }
      ...
      <Card className="p-4 bg-card border border-border">
        ...
        {(!dataInicio || !dataFim) && (
          <p className="text-xs text-muted-foreground mt-2">
            Informe a data de início e fim para consultar as notas emitidas.
          </p>
        )}
      </Card>
